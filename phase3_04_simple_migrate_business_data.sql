-- ============================================================
-- FASE 3.04 SIMPLIFICADA - MIGRAR DADOS DE NEGOCIO SEM AUTH LEGADO
-- Pressupostos:
--   1. As tabelas antigas foram importadas para o schema legacy.
--   2. Existe um admin novo ja promovido por phase3_03e.
--   3. Nao vamos reaproveitar usuarios antigos no Auth novo.
-- ============================================================
